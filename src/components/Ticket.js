    ...
    render() {
        return (
            <div className="container">
                <Panel style={{marginBottom: '10px', width: '80%'}} eventKey={this.props.index + 1 + ''} defaultcollapsed="true"
                    ...
                    <Panel.Heading>
                        <Panel.Title toggle className="text-left">
                            <div className="row">
                                <div><span className="col-lg-9"><b>{this.props.ticket.ticketTitle}</b></span></div>
                                <div><span className="col-lg-3" style={{float: 'right'}}><i><small>{this.props.ticket.user.username}</small></i></span></div>
                            </div>
                            <div className="row">
                                <div><span className="col-lg-3"></span></div>
                                <div><span className="col-lg-6"><img src={expandbutton} width="45" height="12" className="center-block" alt="expandticket"/></span></div>
                                <div><span className="col-lg-3" style={{float: 'right'}}><i><small>{this.props.ticket.timestamp.substring(0, 10)}</small></i> <i><small>{this.props.ticket.timestamp.substring(11)}</small></i></span></div>
                            </div>
                        </Panel.Title>
                    </Panel.Heading>
                    <Panel.Collapse>
                        <Panel.Body className="text-left">
                            <br/>
                            <div className="row">
                                <span className="col-lg-2"><b>Location:</b></span><span
                                className="col-lg-10">{this.props.ticket.location}</span>
                            </div>
                            {/*<div className="row">*/}
                            {/*<span className="col-md-1"><b>Date&Time:</b></span><span className="col-md-11">{this.props.ticket.timestamp}</span>*/}
                            {/*</div>*/}
                            <div className="row">
                                <span className="col-lg-2"><b>Description:</b></span><span
                                className="col-lg-10">{this.props.ticket.ticketDescription}</span>
                            </div>
                            <br/>
                            <div>
                                <span>
